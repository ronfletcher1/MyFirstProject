...
# user can selct from multiple choice questions
# users will be rewarded for answering each question correctly.  
# Requirements:
    # student name
    # list of questions easy and hard
    # each question cost money
    # easy questions are $100; hard questions are $500
    # correct answers = money added to wallet
